...
### 1. Список заявок
![Список заявок](docs/screenshots/1.png)

### 2. Создание новой заявки
![Создание заявки](docs/screenshots/2.png)

### 3. Детали заявки
![Детали заявки](docs/screenshots/3.png)

### 4. Смена статуса и фильтрация
![Смена статуса и фильтрация](docs/screenshots/4.png)
